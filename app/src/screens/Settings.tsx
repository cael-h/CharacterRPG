  ...
  return (
    <View style={{ flex: 1, padding: 12 }}>
      ...
      <View style={{ flexDirection: 'row', marginVertical: 6 }}>
        ...
        <View style={{ width: 8 }} />
        <Button title="Ollama" onPress={() => setProv('ollama' as any)} />
      </View>
      ...
      {prov === 'ollama' && (
        <View style={{ marginVertical: 6 }}>
          ...
          />
          <View style={{ height: 8 }} />
          <Button title="Test Ollama" onPress={testOllama} />
        </View>
      )}
      ...
      <View style={{ marginTop: 12 }}>
        ...
        <View style={{ flexDirection: 'row', marginTop: 6 }}>
          ...
          <View style={{ width: 8 }} />
          <Button title={`Auto${tweak === 'auto' ? ' ✓' : ''}`} onPress={() => setTweak('auto')} />
        </View>
      </View>
      ...
      <View style={{ marginTop: 12 }}>
        ...
        <View style={{ flexDirection: 'row', marginTop: 6 }}>
          <Button
            ...
            onPress={() => setReviewProv(reviewProv === 'openai' ? 'ollama' : reviewProv === 'ollama' ? 'mock' : 'openai')}
          />
          <View style={{ width: 8 }} />
          <TextInput
            value={reviewModel}
            onChangeText={setReviewModel}
            placeholder="reviewer model (e.g., gpt-5-mini)"
